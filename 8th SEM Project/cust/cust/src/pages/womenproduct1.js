...
useEffect(() => {
	//console.log(jackets);
	Axios.get('http://localhost:1337/api/viewproduct', 
	{params: {
		name:procat,
	}}).then((response)=>{
        console.log(response.data);
					...
					<div class="container">
						<div class="product-agileinfo-grids w3l">
								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive " src="./res/images/r.jpg" alt=""/></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="single.html">Product Sample 1  </a></h6>
											<p><del>Rs. 100.00</del> <em class="item_price">Rs. 79.00</em></p>
										</div>	
										<div class="clearfix"> </div>
									</div>
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive " src="./res/images/r1.jpg" alt=""/></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="single.html">Product Sample 2 </a></h6>
											<p><del>Rs. 100.00</del> <em class="item_price">Rs. 49.00</em></p>
										</div>	
										<div class="clearfix"> </div>
									</div>
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive " src="./res/images/r2.jpg" alt=""/></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="single.html">Product Sample 3 </a></h6>
											<p><del>Rs. 100.00</del> <em class="item_price">Rs. 39.00</em></p>
										</div>
										<div class="clearfix"> </div>
									</div>
							...
							<div class="col-md-9 product-agileinfon-grid1 w3l">
                                ...
                                <input type="text"  id="search" class="search_bar"  placeholder="Search for products . . . . .  "/>
									</p>
									<p>
												...
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														...
														<div class="women">
															...
															<span class="size"> Available Stock: {val.P_stock} </span>
