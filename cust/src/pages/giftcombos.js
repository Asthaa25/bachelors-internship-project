...
const procat3 =location.state.name;
//console.log(jackets);
//alert(procat1)
...
useEffect(() => {
	//console.log(jackets);
	Axios.get('http://localhost:1337/api/viewproduct3', 
	{params: {
		name:procat3,
	}}).then((response)=>{
        console.log(response.data);
        setview3(response.data);
        });
							...
							<div class="col-md-3 product-agileinfo-grid">
								<div class="categories">
									...
									<ul class="tree-list-pad">
														...
														<li><a href="products.html"><font  size="4">Men Gift Combos</font></a></li>
														<li><a href="products.html"><font  size="4">Women Gift Combos</font></a></li>
