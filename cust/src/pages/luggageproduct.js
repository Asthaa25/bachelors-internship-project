...
const procat2 =location.state.name;
//console.log(jackets);
//alert(procat1)
...
useEffect(() => {
	//console.log(jackets);
	Axios.get('http://localhost:1337/api/viewproduct2', 
	{params: {
		name:procat2,
	}}).then((response)=>{
        console.log(response.data);
											...
											<div class="product-tab">
												...
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														...
														<img src={"http://localhost:1337/public/"+val.P_images}  height="150" width="150" class="image-size"></img>
